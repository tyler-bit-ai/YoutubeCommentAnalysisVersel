...
- 우측 상단 도움말 버튼을 통한 사용 안내 및 분석 로직 설명
...
키워드 검색 후 관련 영상 카드가 정렬되어 표시되며, 각 카드에서 조회수/댓글 수/구독자 대비 조회수 배율을 바로 확인할 수 있습니다.

![Dashboard](docs/dashboard.png)

### 분석 결과

영상 카드를 클릭하면 댓글과 답글을 기반으로 종합 요약, 장단점, 대표 댓글, 실행 전략이 포함된 Strategic Insight 모달이 열립니다.
